...
imgArr.forEach(() => {
    imgBlock.innerHTML = `<img style="width: ${window.innerWidth * 0.8}px; height: ${window.innerHeight * 0.8}px"; class="image" src="/Homeworks/Homework10/images/${randomNumber}.jpg" alt="">`;
});
